...
class Config {
	...
	static oDataURL;
	static serviceName = "NodeJS Framework Ver 1.0";
	static Port = 7100;
	static SesstionSalt = "Add Session Salt Here";
	static PasswordSalt = "Add Password Salt Here"; /* DO NOT change this value when it is in production mode */
	...
	static async initSetting(Server = {
		...
		// this.DB_Connection_Config = JSON.parse(await fs.readFileSync(`setting/db.${NODE_ENV}.json`));
		if(Server.Env == 'production') {
			...
			*/
			this.HostNameForBackgroundTask = "HostExample_01";
			this.oDataURL = "Add oData URL";
		} else {
			...
			this.HostNameForBackgroundTask = "HostExample_02";
			this.oDataURL = "Add oData URL";
		}
